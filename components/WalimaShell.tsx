...
export function WalimaApp(){return <div className="walima-grid min-h-screen overflow-x-hidden bg-[#0f021e]"><BootSequence/><KonamiEngine/><AchievementDrawer/><DiscoveryToast/><div className="pointer-events-none fixed inset-0 z-0 opacity-80"><div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_15%,rgba(0,255,102,.12),transparent_32%),radial-gradient(circle_at_80%_70%,rgba(255,215,0,.08),transparent_30%)]"/></div><Hero/><section id="dawat" className="relative z-10 mx-auto max-w-6xl px-5 pb-20"><div className="glass rounded-3xl p-8 md:p-14"><p className="text-sm tracking-[.3em] text-[#00ff66]">OUR DAWAT</p><h2 className="mt-3 font-display text-5xl text-[#ffd700] md:text-7xl">The Brotherhood Archive</h2><p className="mt-7 max-w-4xl text-lg leading-8 text-white/80">Wallah, nobody predicted this level of brotherhood. Two legends standing side-by-side in pure Sabr, lifting heavy iron, sipping cold water, and seeking Barakah. Mafi Mushkil — zero drama, maximum loyalty, Alhamdulillah for the ultimate gym-bro synergy.</p></div></section><CharacterEngine/><Phase5/></div>}
